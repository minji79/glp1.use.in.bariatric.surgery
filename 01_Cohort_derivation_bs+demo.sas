...
/************************************************************************************
	1. All Bariatric Surgery(BS) users	     N = 99,350
************************************************************************************/

* 1. explore procedure dataset;
proc contents data=tx.procedure; title "tx.procedure"; run;      /* 1,582,000,163 obs  */

* 2. list up all of the value of code_system;
...
/************************************************************************************
	2. BS users (initial use date) between 2015 - 2021    N = 44055
************************************************************************************/
...
data bs_user_all; set min.bs_user_all_v02; where bs_type in ('rygb', 'sg'); run;
 

/************************************************************************************
	3. Merge "BS users 2015 - 2021" + "demographic data"       N = 44055
************************************************************************************/
...
data bs_user_all_v05; set min.bs_user_all_v05; where bs_type in ('rygb', 'sg'); run; /* 43674 */

/************************************************************************************
	STEP 5. Exclude individuals without sex      N = 1156
************************************************************************************/
...
data bs_user_all_v06; set min.bs_user_all_v06; where bs_type in ('rygb', 'sg'); run; /* 42518*/

/************************************************************************************
	STEP 6. Exclude individuals outside the US       N = 1014
************************************************************************************/
...
data bs_user_all_v07; set min.bs_user_all_v07; where bs_type in ('rygb', 'sg'); run; /* 41504 */
...
data bs_user_all_v08; set min.bs_user_all_v08; where bs_type in ('rygb', 'sg'); run; /* 40975 */
