...
data bs_glp1_user_v02; set min.bs_glp1_user_v02; where bs_type in ('rygb', 'sg'); run; /* 40975 */

/************************************************************************************
	STEP 5. Remove People with death_date < GLP1_initiation_date            (N = 51)
************************************************************************************/
...
data bs_glp1_user_v03;
    set min.bs_glp1_user_v02;
    if not missing(death_date) and death_date < glp1_initiation_date then delete;
run;  
data bs_glp1_user_v03; set bs_glp1_user_v03; where bs_type in ('rygb', 'sg'); run; /* 40924 */
...
data bs_glp1_user_v03; set min.bs_glp1_user_v03; where bs_type in ('rygb', 'sg'); run; /* 35315 */
